    ...
    <Card className="border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-indigo-50 shadow-lg">
      ...
      <CardContent className="space-y-4">
        ...
        {predictions.map((prediction) => (
          <div
            key={prediction.id}
            className="p-4 rounded-xl border border-blue-200 bg-white shadow-md hover:border-blue-300 hover:shadow-lg transition-all"
          >
            <div className="flex items-start justify-between mb-3">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2 flex-wrap">
                  <h4 className="text-sm font-semibold text-gray-900">{prediction.component}</h4>
                ...
                <p className="text-sm text-gray-700 mb-2">{prediction.issueType}</p>
                <p className="text-xs text-gray-600 mb-3">{prediction.recommendedAction}</p>
              </div>
            </div>
            ...
            {(prediction.reasoning || prediction.dataSource) && (
              <div className="mb-3 p-3 bg-blue-50 rounded-lg border border-blue-100">
                <div className="flex items-start gap-2 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="text-xs font-semibold text-gray-700 mb-1">Why this recommendation?</p>
                    ...
                    {prediction.dataSource && (
                      <div className="mt-2 pt-2 border-t border-blue-200">
                        ...
                        <p className="text-xs text-gray-600">{prediction.dataSource}</p>
                      </div>
                    )}
                  </div>
                </div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-3">
              <div className="bg-blue-50 rounded-lg p-2 border border-blue-100">
                <div className="flex items-center gap-1.5 mb-1">
                  ...
                  <p className="text-xs text-gray-600">Time to Failure</p>
                </div>
                <p className="text-sm font-bold text-gray-900">{prediction.timeToFailure}</p>
              </div>
              <div className="bg-blue-50 rounded-lg p-2 border border-blue-100">
                <div className="flex items-center gap-1.5 mb-1">
                  <Calendar size={12} className="text-blue-600" />
                  <p className="text-xs text-gray-600">Predicted Date</p>
                </div>
            ...
            <div className="flex items-center justify-between pt-3 border-t border-blue-200">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-gray-600">{prediction.urgency}</span>
              </div>
              <div className="flex items-center gap-2">
                <Button
                  variant="ghost"
                  size="sm"
                  className="text-xs text-gray-600 hover:text-gray-900 hover:bg-blue-50"
                >
